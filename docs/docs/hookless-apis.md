...
await ExpoLlmMediapipe.downloadModel(
  'https://huggingface.co/ayush-walekar/gemma-tflite/resolve/main/gemma-1.1-2b-it-int4.bin',
...
- [Model loading from assets](https://github.com/AyushWalekar/react-native-llm-litert-mediapipe/blob/main/example/src/screens/HooklessAssetDemoScreen.tsx)
- [Model download and inference](https://github.com/AyushWalekar/react-native-llm-litert-mediapipe/blob/main/example/src/screens/HooklessDownloadableDemoScreen.tsx)
- [Model utility functions](https://github.com/AyushWalekar/react-native-llm-litert-mediapipe/blob/main/example/src/screens/HooklessUtilityDemoScreen.tsx)