      ...
      <header className="navbar">
        <div className="navbar-container">
          ...
          <div className="navbar-actions">
            <Button variant="outline" className="navbar-button mr-2" onClick={() => window.location.href = "https://github.com/AyushWalekar/react-native-llm-litert-mediapipe/"}>
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-section">
            <h3 className="footer-heading">react-native-llm-litert-mediapipe</h3>
          ...
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <div className="hero-actions">
                <Button className="hero-button-primary" onClick={() => window.location.href = "/react-native-llm-litert-mediapipe/docs/getting-started"}>
                  Get Started
                </Button>
              </div>
            </div>
