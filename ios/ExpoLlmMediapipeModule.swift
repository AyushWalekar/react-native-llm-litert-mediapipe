...
public class ExpoLlmMediapipeModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    // Multimodal stubs - not supported on iOS
    AsyncFunction("addImageToSession") { (handle: Int, imagePath: String, promise: Promise) in
      promise.reject("PLATFORM_ERROR", "Multimodal image input is not supported on iOS. This feature is only available on Android.")
    }

    AsyncFunction("addAudioToSession") { (handle: Int, audioPath: String, promise: Promise) in
      promise.reject("PLATFORM_ERROR", "Multimodal audio input is not supported on iOS. This feature is only available on Android.")
    }
